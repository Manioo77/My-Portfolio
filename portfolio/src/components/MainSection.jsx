...
export function MainSection() {
  return (
    <section className="flex h-screen w-full max-w-screen-xl items-center justify-between px-4">
      ...
      <div className="w-7/12 text-white">
        ...
        <button className="my-6 h-11 w-48 rounded-md bg-amber-200 text-slate-900">
          Pobierz CV
        </button>
      </div>
    </section>
